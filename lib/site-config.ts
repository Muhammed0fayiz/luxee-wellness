export const siteConfig = {
  ...
  description:
    "Luxee Wellness Family Salon in Venjarammoodu is a gents and ladies salon offering haircuts, hair spa, hair smoothening & Botox treatments, hydra facials, cleanups, D-tan, manicure and pedicure.",
  ...
  address: {
    ...
    line2: "Alanthara, Venjarammoodu, Nellanad",
    city: "Nellanad",
    state: "Kerala",
    postalCode: "695607",
    country: "IN",
